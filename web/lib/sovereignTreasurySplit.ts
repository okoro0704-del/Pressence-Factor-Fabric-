...
/** Sentinel fee: $100 = 0.1 VIDA, transferred to Sentinel_Wallet_Address. */
export const SENTINEL_FEE_VIDA = 0.1;
...
/** When BETA_LIQUIDITY_TEST: effective spendable is full 1 VIDA ($1000). Import from betaLiquidityTest and use these when flag is set. */
export const FULL_SPENDABLE_VIDA = 1;
export const FULL_SPENDABLE_USD = 1_000;
