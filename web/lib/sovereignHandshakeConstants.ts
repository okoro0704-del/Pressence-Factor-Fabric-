...
/** Citizen total in VIDA (5 VIDA = $5,000). Spendable 0.9 + Locked 4.1 after Sentinel. */
export const NET_SPENDABLE_VIDA = 5;

export { VIDA_PRICE_USD };
export const NAIRA_RATE = 1400;

/** Net citizen share in USD ($5,000 = 5 VIDA). */
export const NET_SPENDABLE_USD = 5_000;
