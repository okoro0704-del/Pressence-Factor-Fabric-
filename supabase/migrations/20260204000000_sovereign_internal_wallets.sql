...
ALTER TABLE sovereign_internal_wallets ADD COLUMN IF NOT EXISTS usdt_deposit_address_erc20 TEXT;
ALTER TABLE sovereign_internal_wallets ADD COLUMN IF NOT EXISTS usdt_deposit_address_trc20 TEXT;
ALTER TABLE sovereign_internal_wallets ADD COLUMN IF NOT EXISTS dllr_balance NUMERIC(24, 8) NOT NULL DEFAULT 0;
ALTER TABLE sovereign_internal_wallets ADD COLUMN IF NOT EXISTS usdt_balance NUMERIC(24, 8) NOT NULL DEFAULT 0;
ALTER TABLE sovereign_internal_wallets ADD COLUMN IF NOT EXISTS vida_cap_balance NUMERIC(24, 8) NOT NULL DEFAULT 0;

CREATE INDEX IF NOT EXISTS idx_sovereign_internal_wallets_phone ON sovereign_internal_wallets(phone_number);
